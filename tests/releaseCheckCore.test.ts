...
function defaultContent(file: string): string {
  if (file === "package.json") {
    return JSON.stringify({ version: "0.3.2-alpha.0" });
  }
  if (file === "package-lock.json") {
    return JSON.stringify({ version: "0.3.2-alpha.0", packages: { "": { version: "0.3.2-alpha.0" } } });
  }
  if (file === "README.md") {
    return "# Readme\n\nAlpha warning\n\nWindows unsigned warning\n\nv0.3.2-pdf-diagnostics-fix\n";
  }
  if (file === "CHANGELOG.md") {
    return "# v0.3.2-pdf-diagnostics-fix\n";
  }
